...
public class ProductViewActivity extends NavigationActivity {// FragmentActivity
	 ...
	 *            previously saved state of the activity
	...
	public static class PageFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(R.layout.activity_product_view,
					container, false);
			...
			OnPageChangeListener listener = new OnPageChangeListener() {
				public void onPageSelected(int arg0) {
					...
					Collection collection = NavigationActivity.collections
							.get(ProductViewActivity.colNum);
					String name = collection.getName() + " " + (arg0 + 1)
							+ " / " + collection.getCountOfImages();
	...
	/**
	 * Help to organize the possibility to switch between the product's views
	 * (each slides)
	 * 
	 * @author Alexandr Brich
	 * @version 1.1
	...
	private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
		 ...
		 * 
		 * @param position
		 *            position in list of images path which mean the particular
		 *            product
