...
public class NavigationActivity extends ActionBarActivity {
	...
	public static ArrayList<Collection> collections;// = new
	 ...
	 *            represents the saved state of the activity
	 */
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (Build.VERSION.SDK_INT < 11) {
			...
			mCustomActionView = inflator
					.inflate(R.layout.action_bar_text, null);
			// assign the view to the actionbar
			getSupportActionBar().setCustomView(mCustomActionView);
			actionBarTitleView = ((TextView) mCustomActionView
		...
		if (collections.size() == 0) { // first start without net access
			noConnect = true;
			setTitle(mozart);
			Toast.makeText(this, R.string.error_no_internet, Toast.LENGTH_LONG)
					.show();
			// Toast.makeText(this, "��� �������� ����������!",
			// Toast.LENGTH_LONG).show();
		}
	...
	private class DrawerItemClickListener implements
		 ...
		 * 
		 * @param arg0
		 *            adapter of the data in the listView
		 * @param arg1
		 *            the listView in which was risen this event
		 * @param arg2
	 ...
	 * 
	 * @param position
	 *            position of the item in list of the navigation drawer
	 */
	 ...
	 * @param menu
	 *            the menu to create
	 * @return true if menu was created without a problems, false if it wasn't
	 *         created or an error
	 */
	@Override
	...
	/**
	 * Inflate the menu in this activity hide the options menu if the navigation
	 * drawer was opened calling whenever the supportInvalidateOptionsMenu() is
	 * called
	 * 
	 * @see android.app.Activity#onPrepareOptionsMenu(android.view.Menu)
	 * @param menu
	 *            the menu to prepare
	 * @return true if menu was updated without a problems, false if it was a
	 *         problem
	 */
	@Override
	...
	/**
	 * Calling when was selected the options item (in Action bar or options
	 * menu)
	 * 
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (item.getItemId() == R.id.action_update) {
			...
			collections.clear();
			// forcing to update the xml file (second parameter - update
			// options)
	...
	/**
	 * Calling after creating the activity before showing it synchronize action
	 * bar
	 * 
	 * @see android.app.Activity#onPostCreate(android.os.Bundle)
	 * @param savedInstanceState
	 *            represents the state of the activity
	 */
	@Override
	 ...
	 * @param newConfig
	 *            the new configuration of the activity
	 */
	@Override
